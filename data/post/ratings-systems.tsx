  ...
  return (
    <>
      ...
      <p>
        ...
        no grade at all. He expanded his system to include{" "}
        <Link
      ...
      <p>
        A glorious anon took the time to record{" "}
        <Link
        ...
        />{" "}
        with high fidelity. Scores like "Strong 8 to [Light 9]" and "[Light] to
        Decent 4" are peak Fantanocore.
      </p>
...
export default post(import.meta, {
  ...
  tags: ["media", "design", "language", "data"],
  content: <Content />,
});
