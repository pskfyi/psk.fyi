...
function Teaser() {
  return (
    <span class="hyphens-none">
      Why I decline to write Node.js for my personal projects.
    </span>
  );
}
  ...
  return (
    <>
      ...
      <p>
        ...
        with Ryan's famous talk<Link
          spaced
          to="https://www.youtube.com/watch?v=M3BM9TB-8yA"
          text="10 Things I Regret About Node.js"
        />where he layed out a compelling rationale for ripping Node down to its
        studs. In 2020, after a lengthy rewrite from Go to Rust,<Link
          spaced
      ...
      <p>
        To a rare breed of<Link
          spaced
          to="https://www.skypack.dev/"
          text="Skypack"
      ...
      <p>
        Its vastly superior<Link
          spaced
          to="/tag/dx"
          text="developer experience"
        />was immediately apparent. After about a month of after-hours
        tinkering, I have since then never written a line of Node.js outside of
        work. It's been over a year and I'm here to stay.
      </p>
      ...
      <p>
        ...
        some exciting features lately, most notably their built-in<Link
          spaced
