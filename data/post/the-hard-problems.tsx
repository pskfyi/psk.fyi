  ...
  return (
    <>
      <p class="my-0 text-left hyphens-none leading-5">
        Generated via
        <Link.Wiki to="Stable_Diffusion" spaced /> using{" "}
  ...
  return (
    <>
      ...
      <p>
        ...
        also an ultimate bikeshedding and an ultimate procrastination - I have
        great goals, and in order to achieve them I must first architect a
        life-path, and before I can do that I must learn life architecture...
        I'm making an apple pie from scratch.
      </p>

      <a href="https://www.youtube.com/watch?v=BkHCO8f2TWs">
        <Pic src="/post/apple-pie.webp" />
      </a>

      <p>
        A primary interest of this blog will be an exploration of these problems
        and their solutions. The final result will be a{" "}
        <Link to="/tag/knowledge management" text="knowledge management" />{" "}
...
export default post(import.meta, {
  ...
  teaser: (
    <>
      The hardest problem is learning how to live towards&nbsp;death.
    </>
  ),
  content: <Content />,
});
