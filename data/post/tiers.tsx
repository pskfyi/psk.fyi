  ...
  return (
    <>
      ...
      <p>
        ...
        {" "}
        <Link.Wiki spaced to="Likert_scale" text="7-point Likert scale" />. I
        was doing a one-dimensional qualitative analysis with a neutral middle
        rank, strongly negative and positive extremes, and two gradations in
        between which I think of as analogous to the difference between
        North-Northwest and West-Northwest. I think he was spot on. But what was
        I measuring?
      </p>
