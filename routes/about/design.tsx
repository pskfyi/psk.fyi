...
import { Swatch } from "/components/Docs.tsx";
...
export default () => (
  <Page tab="Design System" preview={preview}>
    ...
    <p>
      ...
      <em>on a supporting display</em>, is the most vibrant neon orange that CSS
      can presently produce.
    </p>

    <p>
      I knew I wanted a dark theme as my default because it is my preference. It
      also lets the orange pop more. I took inspiration from the
      grayscale-with-orange-accent schemes common in many text editors, but I
      wanted something more harmonious than the sterile grays they often use. To
      support that, I added the very warm gray <Swatch torch="soot" />{" "}
      as my background color. All the other colors were developed as needs arose
      for them, and the naming scheme came later.
    </p>
    ...
    <p class="font-display text-xl">
      ...
      <span className="fake-font-black">this black weight</span>. Additionally,
      iOS and Android will render the font with a{" "}
      <a
    ...
    <p>
      On mobile, paragraphs are justified and have hyphenation enabled to handle
      excessive ragging. Above that, paragraphs revert to normal except the base
      font size is increased to 1.125rem (18px) for leisurely reading.
    </p>
    ...
    <p>
      ...
      justo sit amet orci <a>vestibulum</a> fringilla. Mauris <em>iaculis</em>
      {" "}
    ...
    <blockquote>
      Vestibulum tempus bibendum odio, scelerisque lobortis libero pellentesque
      non. Fusce nec fermentum ante.
    </blockquote>
    ...
    <p>
      ...
      ut arcu accumsan interdum. Proin tincidunt nisi venenatis magna vehicula,
      ut accumsan libero euismod. Vivamus ultrices augue consequat eros
      scelerisque, id vestibulum augue pretium. Fusce vulputate turpis id arcu
      volutpat convallis.
    </p>
    ...
    <p>
      Maecenas egestas odio in fermentum lobortis. Sed sit amet purus efficitur,
      fermentum nibh in, vulputate quam. Orci varius natoque penatibus et magnis
      dis parturient montes, nascetur <a href="#typography">ridiculus</a> mus.
    </p>
    ...
    <p>
      ...
      condimentum magna nibh ac felis. Aenean posuere, urna non rhoncus sodales,
      leo augue tincidunt turpis, et tempus nulla metus eu metus. Cras quis
      egestas libero. Vivamus molestie et diam ut tincidunt.
    </p>
