...
import { Swatch, SwatchDocs } from "../../components/docs/Swatch.tsx";
import { Pic, PicDocs } from "../../components/pics.tsx";
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Character-level<Link
          spaced
          to="https://developers.google.com/fonts/docs/getting_started#specifying_script_subsets"
          text="subsetting"
        />is used to retrieve only this character from the CDN, costing only
        about 1kb total between the font file and style sheet. See this in
        action in <Link to="/post/tiers">this blog post</Link>'s title.
      </p>
